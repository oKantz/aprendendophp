...
<div class="container">
    ...
    if(isset($_POST['addnew'])){
        if(empty($_POST['firstname']) || empty($_POST['lastname']) || empty($_POST['adress']) || empty($_POST['contact'])){
            ...
            $sql = "INSERT INTO users (firstname, lastname, adress, contact) VALUES ('$firstname', '$lastname', '$adress', '$contact')";
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="box">
                ...
                <form action="" method="POST">
                    ...
                    <textarea rows="4" name="adress" id="adress" class="form-control"></textarea><br>

                    <label for="contact">Contact</label>
                    <input type="text" name="contact" id="contact" class="form-control"><br><br>
